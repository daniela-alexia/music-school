                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <i class="ri-mail-send-line"></i>
                                    <span>Teachers Setup</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('all.teachers') }}">All Teachers</a></li>
                                    <li><a href="{{ route('add.teachers') }}">Add Teachers</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <i class="ri-mail-send-line"></i>
                                    <span>Instruments Page Setup</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('all.instruments') }}">All Instruments</a></li>
                                    <li><a href="{{ route('add.instruments') }}">Add Instruments</a></li>
