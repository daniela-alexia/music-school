...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Courses Page </h4>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="courses_name" class="form-control" type="text" id="example-text-input">
                    @error('courses_name')
            ...
            <!-- end row -->
              ...
              <!-- <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Courses Title </label>
                <div class="col-sm-10">
                    <input name="courses_title" class="form-control" type="text" id="example-text-input">
                    @error('courses_title')
                    <span class="text-danger"> {{ $message }} </span>
                    @enderror
                </div>
  ...
  <img id="showImage" class="rounded avatar-lg" src="{{ url('upload/no_image.jpg') }}" alt="Card image cap">
            ...
            <!-- end row -->
<input type="submit" class="btn btn-info waves-effect waves-light" value="Insert Courses Data">
            </form>
