...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Teachers Page </h4>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="teachers_name" class="form-control" type="text" id="example-text-input">
                    @error('teachers_name')
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="teachers_course" class="form-control" type="text" id="example-text-input">
            ...
            <!-- end row -->
<input type="submit" class="btn btn-info waves-effect waves-light" value="Insert Teachers Data">
            </form>
