                ...
                <div class="row justify-content-between">
                    <div class="col-lg-4">
                        <div class="footer__widget">
                            <div class="fw-title">
                                <h5 class="sub-title">Contactează-ne</h5>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="footer__widget">
                            <div class="fw-title">
                                <h5 class="sub-title">Adresa</h5>
                                <h4 class="title">ROMÂNIA</h4>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="footer__widget">
                            <div class="fw-title">
                                <h5 class="sub-title">Urmărește-ne</h5>
                                <h4 class="title">Rețele de socializare</h4>
                            </div>
