...
@section('main')
 ...
 <main>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-8 col-md-10">
                            <div class="breadcrumb__wrap__content">
                                <h2 class="title">{{ $courses->courses_name }}</h2>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">{{ $courses->courses_name }}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
  ...
  <img src=" {{ asset($courses->courses_image) }} " alt="">
                            </div>
                                ...
                                <!-- <div class="widget">
                                    ...
                                    <ul class="sidebar__contact__info">
                                        ...
                                        <li class="cagegory"><span>Category :</span>
                                            <a href="courses.html">Photo,</a>
                                            <a href="courses.html">UI/UX</a>
                                        </li>
                                        <li><span>Project Link :</span> <a href="courses-details.html">https://www.yournews.com/</a></li>
                                    </ul>
                                </div> -->
                                <!-- <div class="widget">
